...
const LoginPage = ({ onAuthSuccess }) => {
    ...
    const [user, setUser] = useState(null); // To hold the authenticated user
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            setEmail('');
            setPassword('');
            // The onAuthSuccess callback will be triggered by onAuthStateChanged
        } catch (error) {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // The onAuthStateChanged listener will handle updating the user state and calling onAuthSuccess
        } catch (error) {
    ...
    // Removed the conditional rendering for "Welcome!" message.
    // The parent component (e.g., App.jsx) should handle redirection
    // based on the 'user' state or the 'onAuthSuccess' callback.
            ...
            <div className="bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full">
                ...
                <div className="mt-6 text-center">
                    <p className="text-gray-400">
                        ...
                        <a href="/signup" className="text-red-400 hover:text-red-500 font-semibold transition duration-200">Sign Up</a>
                    </p>
                </div>
            </div>
        </div>
